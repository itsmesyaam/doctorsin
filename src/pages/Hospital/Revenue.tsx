...
export const Revenue: React.FC = () => {
  ...
  // Localized Kochi transactions list
  const transactions = [
    { id: 'TXN-90234', patient: 'Hari Krishnan', dept: 'Cardiology', date: '2026-07-01', amount: 800, status: 'Settled' },
    { id: 'TXN-90235', patient: 'Anjali Menon', dept: 'Dermatology', date: '2026-07-01', amount: 600, status: 'Settled' },
    { id: 'TXN-90236', patient: 'Rahul Varghese', dept: 'Paediatrics', date: '2026-06-30', amount: 500, status: 'Settled' },
    { id: 'TXN-90237', patient: 'Anil Kumar', dept: 'Neurology', date: '2026-06-29', amount: 1000, status: 'Settled' },
    { id: 'TXN-90238', patient: 'Lakshmi Menon', dept: 'Cardiology', date: '2026-06-28', amount: 800, status: 'Settled' }
  ];
